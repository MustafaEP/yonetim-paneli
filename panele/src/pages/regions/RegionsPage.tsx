...
const RegionsPage: React.FC = () => {
  ...
  const handleAssignInstitutions = async () => {
    ...
    try {
      ...
      setError(e.response?.data?.message || 'Kurumlar eklenirken bir hata oluştu');
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleAssignTevkifatCenters = async () => {
    ...
    try {
      ...
      setError(e.response?.data?.message || 'Tevkifat merkezleri eklenirken bir hata oluştu');
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleAssignBranches = async () => {
    ...
    try {
      ...
      setError(e.response?.data?.message || 'Şubeler eklenirken bir hata oluştu');
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleUnlink = async () => {
    ...
    try {
      ...
      setError(e.response?.data?.message || 'Bağlantı koparılırken bir hata oluştu');
    } finally {
      setUnlinking(false);
    }
  };
