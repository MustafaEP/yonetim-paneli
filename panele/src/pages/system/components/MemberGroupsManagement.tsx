...
const MemberGroupsManagement: React.FC<MemberGroupsManagementProps> = ({
  ...
  const loadMemberGroups = async () => {
    ...
    try {
      ...
      toast.error('Üye grupları yüklenirken bir hata oluştu');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Üye grubu kaydedilirken bir hata oluştu');
    }
  };
  ...
  const handleMove = async (id: string, direction: 'up' | 'down') => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Sıra güncellenirken bir hata oluştu');
    } finally {
      setMoving(null);
    }
  };
  ...
  const handleToggleActive = async (group: MemberGroup) => {
    try {
      ...
      toast.error('Üye grubu güncellenirken bir hata oluştu');
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Üye grubu silinirken bir hata oluştu');
    }
  };
