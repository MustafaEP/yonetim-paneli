// src/components/accounting/DeleteTevkifatCenterDialog.tsx
...
import { deleteTevkifatCenter, type DeleteTevkifatCenterDto, type TevkifatCenter } from '../../api/accountingApi';
