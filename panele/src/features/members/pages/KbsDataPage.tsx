  ...
  return (
    <PageLayout>
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        <PageHeader
          icon={<CloudDownloadIcon sx={{ color: '#fff', fontSize: { xs: '1.8rem', sm: '2rem' } }} />}
          title="KBS Veri Çekme"
          description="Kamu Bilgi Sistemi entegrasyonu ve veri senkronizasyonu"
          color="#1565c0"
          darkColor="#0d47a1"
          lightColor={alpha('#1565c0', 0.06)}
        />
